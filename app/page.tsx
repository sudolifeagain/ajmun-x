        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <div className="space-y-4">
            <Link
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#5865F2] px-6 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:bg-[#4752C4] hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
            >
